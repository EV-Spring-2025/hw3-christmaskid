...
def decode_param_json(json_file, material, n_grid, substep_dt, 
                      grid_v_damping_scale, softening):
    f = open(json_file)
    ...
    if "material" in sim_params.keys():
        if material:
            material_params["material"] = material
        else:
    ...
    if "grid_v_damping_scale" in sim_params.keys():
        if grid_v_damping_scale:
            material_params["grid_v_damping_scale"] = grid_v_damping_scale
        else:
    ...
    if "substep_dt" in sim_params.keys():
        if substep_dt:
            time_params["substep_dt"] = substep_dt
        else:
